...
namespace DerailedDeliveries.Framework.Train
{
    ...
    public class TestEngineController : NetworkBehaviour
    {
        private void Update()
        {
            ...
            if (Keyboard.current.homeKey.wasPressedThisFrame) TrainEngine.Instance.SetEngineState(
                TrainEngine.Instance.EngineState == TrainEngineState.Active 
                ? TrainEngineState.Inactive 
                : TrainEngineState.Active);
